...
export class OrderBuilder {
    ...
    async buildOrder(userOrder, options, version) {
        ...
        return createOrder(signer, this.chainId, this.signatureType, this.funderAddress, userOrder, options, version);
    }
    /**
    ...
    async buildMarketOrder(userMarketOrder, options, version) {
        const signer = await this.resolveSigner();
        return createMarketOrder(signer, this.chainId, this.signatureType, this.funderAddress, userMarketOrder, options, version);
    }
