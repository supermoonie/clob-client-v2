...
export declare const HEARTBEAT = "/v1/heartbeats";
...
export declare const GET_MARKET_BY_TOKEN = "/markets-by-token/";
export declare const GET_CLOB_MARKET = "/clob-markets/";
...
export declare const GET_PRE_MIGRATION_ORDERS = "/data/pre-migration-orders";
...
export declare const GET_MARKET_TRADES_EVENTS = "/markets/live-activity/";
export declare const GET_BUILDER_TRADES = "/builder/trades";
export declare const GET_BUILDER_FEES = "/fees/builder-fees/";
